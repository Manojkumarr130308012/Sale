...
import com.example.sale.Adapter.ItemListRecyclerViewAdapter;
...
public class Allitems extends Fragment implements INetworkCallBack {
View view;
    DBHelper dbHelper;
    String id,na,pa;
   private OnListFragmentInteractionListener mListener;
    List<ItemData> mCustomerList = new ArrayList<>();
    ItemListRecyclerViewAdapter mRcvAdapter;
    ...
    public static Fragment createInstance(Context context) {
        return Fragment.instantiate(context, Allitems.class.getName(), null);
    }

    public static final String TAG = Allitems.class.getName();
...
//        apiInterface = APIClient.getClient().create(APIInterface.class);
        mRcvAdapter = new ItemListRecyclerViewAdapter(mCustomerList, mListener, mContext);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_allitems, container, false);
...
//    }
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListPaymentInteraction(ItemData item);

        void onListOrderInteraction(ItemData item);
    }
...
//                            message = (String) response.get("status");
                            ...
                            for(int i=0;i<jObject1.length();i++){
                                ...
                                ItemData addobj = new ItemData();
                                addobj.setCustomerID(jsonObject.optString("ID"));
                                addobj.setCustomername(jsonObject.optString("PrintName"));
                                addobj.setCustomerMobile(jsonObject.optString("Description"));
                                addobj.setCustomerCityName(jsonObject.optString("UnitID"));
                                addobj.setCustomerOSAmount(jsonObject.optString("SellingRate"));
...
//                    mTxtExpense.setText(objResDetails.getTodayPayments()+" Rs");
    ...
    public void SetCustomerListAdapter(List<ItemData> _ArrayList) {
