...
import com.example.sale.Adapter.TicketListRecyclerViewAdapter;
...
public class TicketListFragment extends Fragment implements INetworkCallBack {
    DBHelper dbHelper;
    String id,na,pa;
    private OnListFragmentInteractionListener mListener;
    List<TicketData> mCustomerList;
    TicketListRecyclerViewAdapter mRcvAdapter;
...
//    APIInterface apiInterface;
    ...
    public static final String TAG = TicketListFragment.class.getName();

    public static Fragment createInstance(Context context) {
        return Fragment.instantiate(context, TicketListFragment.class.getName(), null);
    }
...
//        apiInterface = APIClient.getClient().create(APIInterface.class);
        mRcvAdapter = new TicketListRecyclerViewAdapter(mCustomerList, mListener, mContext);
    }
...
//    }
    ...
    public interface OnListFragmentInteractionListener {
        ...
        void onListPaymentInteraction(TicketData item);

        void onListOrderInteraction(TicketData item);
    }
...
//                            message = (String) response.get("status");
                            ...
                            for(int i=0;i<jObject1.length();i++){
                                ...
                                TicketData addobj = new TicketData();
                                addobj.setTicketID(jsonObject.optString("TicketID"));
                                addobj.setTicketNo(jsonObject.optString("TicketNo"));
                                addobj.setTicketDate(jsonObject.optString("TicketDate"));
                                addobj.setCustomerName(jsonObject.optString("CustomerName"));
                                addobj.setCustomerAddress(jsonObject.optString("CustomerAddress"));
                                addobj.setDescription(jsonObject.optString("Description"));
                                addobj.setPriority(jsonObject.optString("Priority"));
                                addobj.setStatus(jsonObject.optString("Status"));
                                addobj.setCreatedBy(jsonObject.optString("CreatedBy"));
...
//                    mTxtExpense.setText(objResDetails.getTodayPayments()+" Rs");
    ...
    public void SetCustomerListAdapter(List<TicketData> _ArrayList) {
